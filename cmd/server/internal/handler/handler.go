...
type Service interface {
	...
	MedalsByCountryAndDiscipline(ctx context.Context, countryID, gameID int64) ([]model.DisciplineMedalCount, error)
	TopAthletes(ctx context.Context, gameID int64, minMedals int) ([]model.TopAthlete, error)
}
